...
from tboi_inverted_room_mutation_ea import Inverted_TBoI_Room_Mutation
import time
import numpy as np
import logging
import matplotlib
...
if __name__ == "__main__":
    mutations_root = "Bitmaps/Mutations"
    inputRoomNumber = 0
        ...
        if os.path.isdir(folder_path) and foldername.startswith("bitmap_"):
            for filename in os.listdir(folder_path):
                ...
                save_room_mutations_for_room(
                    os.path.join("Bitmaps/Inverted_Mutations", foldername, filename),
                    mutations,
                    0
                )
