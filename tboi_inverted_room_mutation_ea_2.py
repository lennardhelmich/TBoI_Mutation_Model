...
import random
import copy
from inverted_fitness_function_2 import Inverted_Fitness_Function
...
class Inverted_TBoI_Room_Mutation:
    ...
    def fitness_function(self, individual):
        fitness = Inverted_Fitness_Function(startBitmap=self.startBitmap, resultBitmap=individual)
    ...
    def calculate_mutations(self, NGEN, CXPB, MUTPB, popSize, numElites):
        ...
        try:
            ...
            for gen in range(NGEN):
                ...
                fitness_obj = Inverted_Fitness_Function(startBitmap=self.startBitmap, resultBitmap=best_ind)
